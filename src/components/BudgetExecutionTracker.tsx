    ...
    <GlassCard className="border-t-4 border-t-indigo-500" noPadding>
      ...
      <div className="p-5 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          {/* 2) Monthly Spending Chart - FIXED HEIGHT */}
          <div className="h-52 w-full bg-white dark:bg-slate-800/50 p-4 rounded-xl border border-slate-100 dark:border-slate-700">
          ...
          {/* 4) Milestone Table - FIXED HEIGHT */}
          <div className="flex flex-col h-52 bg-white dark:bg-slate-800/50 rounded-xl border border-slate-100 dark:border-slate-700 overflow-hidden">
